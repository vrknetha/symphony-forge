...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    ...
    >
      <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">{project.status}</p>
      <h2 className="mt-3 font-display text-2xl text-surface-foreground">{project.name}</h2>
